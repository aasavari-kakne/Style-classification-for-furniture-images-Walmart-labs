...
#    dataset_train, dataset_test = get_imagenet_datasets(args.image_folder, num_classes = args.num_classes, train_split = 0.8, random_seed = 42)
   ...
   optimizer_enc = torch.optim.Adam(params = res_encoder_model.parameters(), lr = 0.0000001) # Train encoder slower than the classifier layers
   optimizer_cls = torch.optim.Adam(params = res_classificator_model.parameters(), lr = 0.000001)
